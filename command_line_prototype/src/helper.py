...
def read_train_data(directory_path):
    ...
    print("The database from '"+str(directory_path)+"' has been loaded.")
    return file_paths, dids, docs
...
def load_train_data():
    ...
    print("All the documents are successfully loaded.")
    return docs, file_paths, dids


def read_concept_data(directory_path):
    index = 0
    c_docs = []
    c_dids = []
    c_file_paths = []
...
def load_concept_data():
    ...
    print("All the concept documents are successfully loaded.")
    return c_docs, c_file_paths, c_dids